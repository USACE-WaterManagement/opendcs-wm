...
/**
 * NOTE This is intentionally copied from the OpenDCS Rest API main code.
 * The usage of the ListCompApps will be changed to use the API output once
 * available, however, at the moment we need the data so it might as well be in the same format.
 */
